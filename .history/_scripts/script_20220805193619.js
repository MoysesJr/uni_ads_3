...
$("#seguimentos-atendidos-conteudo").waypoint(function() {
    $("#seguimentos-mestre").addClass("animate__animated animate__backInDown animate__slow");
    $("#botao-seguimentos").addClass("animate__animated animate__backInDown animate__slow");
