...
$("#chamada").waypoint(function(direcao) {
    ...
    $("#chamada-box-esquerda h4").addClass("animate__animated animate__fadeInUp slow animate__slower");
    $("#chamada-box-esquerda a").addClass("animate__animated animate__fadeInUp slow");
