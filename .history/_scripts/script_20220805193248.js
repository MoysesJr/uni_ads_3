...
$("#chamada").waypoint(function(direcao) {
    ...
    $("#chamada-box-esquerda h1").addClass("animate__animated animate__fadeInDown slow animate__slow");
    $("#chamada-box-esquerda h4").addClass("animate__animated animate__fadeInUp slow animate__slow ");
    $("#chamada-box-esquerda a").addClass("animate__animated animate__fadeInUp slow animate__slower");
...
$("#pontos-chave-mestre").waypoint(function(direcao) {
    ...
    $("#pontos-chave-esquerda").addClass("animate__animated animate__fadeInLeft slow animate__slow");
    $("#pontos-chave-direita").addClass("animate__animated animate__fadeInRight slow animate__slow ");
...
$("#seguimentos-atendidos-conteudo").waypoint(function() {
    $("#seguimentos-mestre").addClass("animate__animated animate__backInDown animate__sloe")
})
