...
$("#pontos-chave-mestre").waypoint(function(direcao) {
    ...
    $("#pontos-chave-esquerda").addClass("animate__animated animate__fadeInDown slow animate__slow");
    $("#pontos-chave-direita").addClass("animate__animated animate__fadeInUp slow animate__slow ");
    $("#chamada-box-esquerda a").addClass("animate__animated animate__fadeInUp slow animate__slower");
