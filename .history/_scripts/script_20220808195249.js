...
var $meuMenu = $('#'); // guardar o elemento na memoria para melhorar performance
...
$("#pontos-chave-mestre").waypoint(function(direcao) {
    ...
    $("#pontos-chave-esquerda").addClass("animate__animated animate__fadeInLeft animate__slower");
    $("#pontos-chave-direita").addClass("animate__animated animate__fadeInRight animate__slower");
...
$("#parceiros-conteudo").waypoint(function (){
    $("#parceiros-centro").addClass("animate__animated animate__backInDown");
},{
    offset:"400x;"
})
